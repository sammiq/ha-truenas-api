...
1. In the `custom_components` directory (folder) create a new folder called `ha-truenas-api`.
1. Download _all_ the files from the `custom_components/ha-truenas-api/` directory (folder) in this repository.
